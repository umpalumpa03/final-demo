...
describe('MessagingStore', () => {
    ...
    it('should have markMailasRead method and call it without error', () => {
        expect(typeof store.markMailasRead).toBe('function');
        // This should not throw, even if no mails exist
        expect(() => store.markMailasRead(123)).not.toThrow();
    });
});